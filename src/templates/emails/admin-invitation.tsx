      ...
      >
        ...
        >
          <Section style={{ textAlign: "center", paddingBottom: 20 }}>
            <Heading style={{ margin: 0, fontSize: 24, color: "#111827" }}>
              Djavacoal
            </Heading>
          ...
          <Section style={{ paddingBottom: 16 }}>
            ...
            >
              You have been invited to join the djavacoal workspace. Click the
              button below to accept the invitation. This link will expire in 24
              hours.
            </Text>
