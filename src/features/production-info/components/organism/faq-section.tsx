...
function FAQItem({
  ...
  return (
    <div className="rounded-md overflow-hidden border border-[#4A4A4A] transition-all duration-300">
      {/* Pertanyaan */}
      <button
        onClick={onClick}
        className={`w-full flex items-center justify-between text-left px-4 py-3 transition-colors duration-300 h-16 ${
      ...
      <AnimatePresence initial={false}>
        {open && (
          <motion.div
            ...
            className="overflow-hidden bg-[#35362D] border-t border-[#2B2B2B]"
          >
            <div className="px-4 pb-4 pt-2 text-[#EAEAEA] text-sm md:text-base leading-relaxed">
...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="scroll-mt-28 bg-[#222222] rounded-xl">
      {/* Header */}
