 ...
 * Used in hero sections or statistics displays with hover effects
 */
export function StatCard({
    ...
    return (
        <div
            className={cn(
                "group relative overflow-hidden rounded-[18px] border border-[#3A3A3A] bg-[#2A2A2A80] p-6 text-center backdrop-blur-md transition-all duration-300 hover:border-[#EFA12D] hover:bg-[#2A2A2ACC] md:p-8",
                className
            )}
        >
            {/* Icon Circle */}
