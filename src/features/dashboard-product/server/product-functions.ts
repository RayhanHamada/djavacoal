...
export const getProductById = base
    ...
    .handler(async function ({ context: { env }, input, errors }) {
        ...
        const detail: ProductDetail = {
            ...
            en_description_key: product[PRODUCT_COLUMNS.EN_DESCRIPTION],
            ar_description_key: product[PRODUCT_COLUMNS.AR_DESCRIPTION],
    ...
    .handler(async function ({ context: { env }, input, errors }) {
        ...
        const productResult = await db
            ...
            .values({
                ...
                en_description: input.en_description_key,
                ar_description: input.ar_description_key,
                moq: input.moq,
