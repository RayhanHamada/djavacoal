/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 65907d03156ec1dbede575652cb794ac)
// Runtime types generated with workerd@1.20251105.0 2025-09-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		DJAVACOAL_KV: KVNamespace;
		BUN_VERSION: "1.3.0";
		...
		NEXT_PUBLIC_WHATSAPP_NAME: string;
		FIGMA_API_KEY: string;
		SMTP_USER: string;
		SMTP_PASS: string;
		RECIPIENT_EMAIL: string;
		DJAVACOAL_BUCKET: R2Bucket;
		DJAVACOAL_DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUN_VERSION" | "NODE_ENV" | "NEXTJS_ENV" | "NEXT_PUBLIC_BASE_URL" | "NEXT_PUBLIC_ASSET_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_API_TOKEN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_BASE_PATH" | "S3_API" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "RESEND_API_KEY" | "SENDER_EMAIL" | "NEXT_PUBLIC_WHATSAPP_NUMBER" | "NEXT_PUBLIC_WHATSAPP_NAME" | "FIGMA_API_KEY" | "SMTP_USER" | "SMTP_PASS" | "RECIPIENT_EMAIL">> {}
}
